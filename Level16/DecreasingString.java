...
public class DecreasingString {
    ...
    static int deletedBefore(boolean[] deleted, int idx) {
        int cnt = 0;
        for (int i = 0; i < idx; i++) {
            if (deleted[i]) {
                cnt++;
    ...
    static void solve() throws IOException {
        ...
        Arrays.sort(s2);
        StringBuilder sb2 = new StringBuilder(new String(s2)).reverse();
        ...
        System.out.print(ans.charAt(pos - 1));
    }
