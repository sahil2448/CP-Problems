...
public class D {
    ...
    static void solve() throws IOException {
        ...
        long leftZeros = (leftSide + 1) / 4 + 1;
        long leftOnes = (leftSide + 3) / 4;

        long rightZeros = ((n + 1) / 4 + 1) - leftZeros;
        long rightOnes = ((n + 3) / 4) - leftOnes;

        long ans = 0;

        long temp1 = (leftZeros % MOD) * (rightZeros % MOD);
        ans = temp1 % MOD;

        long temp2 = (leftOnes % MOD) * (rightOnes % MOD);
