...
public class A {
    ...
    static void solve() throws IOException {
        ...
        int countGreater = n - firstGreater;
        int countSmaller = lastSmaller + 1;

        if (countGreater > countSmaller) {
            // Target the right side: Bob needs to be just closer to v[firstGreater] than 'a' is
            System.out.println(2 * v[firstGreater] - a - 1);
        } else if (countSmaller > 0) {
            // Target the left side: Bob needs to be just closer to v[lastSmaller] than 'a' is
            System.out.println(2 * v[lastSmaller] - a + 1);
        } else {
            // If there are no marbles < a or > a (all marbles == a), Bob can pick anything
