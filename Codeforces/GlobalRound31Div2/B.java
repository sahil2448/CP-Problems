...
public class B {
    ...
    static void solve() throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            String left = new StringBuilder(ai.length() + ans.length())
                    .append(ai).append(ans).toString();
            String right = new StringBuilder(ai.length() + ans.length())
                    .append(ans).append(ai).toString();

            ans = (left.compareTo(right) <= 0) ? left : right;
        }
